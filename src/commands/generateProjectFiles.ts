...
export async function generateProjectFiles(): Promise<void> {
 ...
 */
export async function askProjectFilesGeneration() {
  ...
  if (!project) {
    ...
    await vscode.window
      .showInformationMessage(
        "No project found. Would you like to scan for a project?",
        "Yes",
        "No"
      )
      .then((answer) => {
  ...
  const answer = await vscode.window.showInformationMessage(
    "Would you like to generate project files?",
    "Yes",
    "No"
  );
  if (answer === "Yes") {
    ...
    await vscode.commands
      .executeCommand("uetools.generateProjectFiles")
      .then(() =>
