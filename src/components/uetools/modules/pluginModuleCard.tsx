  ...
  return (
    <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      <ModuleCard.ModuleCard>
        <ModuleCard.ModuleThumbnail
          img={
            VSCodeWrapper.workspaceUri +
            encodeURI(
              `/Plugins/${props.plugin.Modules[0].Name}/Resources/Icon128.png`
            )
          }
          width={100}
          height={100}
        ...
        <ModuleCard.ModuleDescription>
          <ModuleCard.ModuleTitleWrapper>
            <ModuleCard.ModuleTitle>
              {props.plugin.FriendlyName}
            </ModuleCard.ModuleTitle>
            <ModuleCard.ModuleVersion>
              ({props.plugin.VersionName})
            </ModuleCard.ModuleVersion>
          </ModuleCard.ModuleTitleWrapper>
          {isMouseHovering && (
            <ModuleCard.ButtonsWrapper isHorizontal>
              <ModuleCard.Button onClick={onBuildModule}>
                Build Module
              </ModuleCard.Button>
          ...
          {!isMouseHovering && (
            <div>
              <ModuleCard.ModuleDescriptionText>
                {props.plugin.Description}
              </ModuleCard.ModuleDescriptionText>
              <Layout>
                <ModuleCard.ModuleAuthor>
                  by {props.plugin.CreatedBy}
                </ModuleCard.ModuleAuthor>
                <ModuleCard.ModduleAuthorUrl href={props.plugin.CreatedByURL}>
                  {props.plugin.CreatedByURL}
                </ModuleCard.ModduleAuthorUrl>
              </Layout>
            </div>
          )}
        </ModuleCard.ModuleDescription>
